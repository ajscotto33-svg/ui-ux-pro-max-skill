# Andrew Scotto | Douglas Elliman — Luxury Real Estate Site
...
```bash
cd projects/andrew-scotto-realty
...
```bash
curl -L -o assets/hero.mp4 "https://d8j0ntlcm91z4.cloudfront.net/user_3GIGRwFkw7yyzrAmJxMkkQFlLZP/hf_20260714_144451_dd12aefe-37fe-4ffa-9ac9-dadc9ed1ba29.mp4"
```
...
- **Phone / email / social links** in the Contact section and `js/main.js` (`mailto:` handoff) — currently `(305) 555-0123` / `andrew.scotto@elliman.com`.
- **Stats** in the About section (150+ families, $200M+, 15+ neighborhoods) are sample marketing numbers.
...
- **Portrait** — replace the `AS` monogram block in About with a real photo.
